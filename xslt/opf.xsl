...
<xsl:stylesheet
  ...
  exclude-result-prefixes="#default date dc dcterms epub exsl m ncx opf pls set ssml str svg d"
  version="1.0">
...
<!--==============================================================-->
<!-- Base Directory -->
<xsl:variable name="base.dir">epub/</xsl:variable>
<!-- OEBPS Directory -->
<xsl:variable name="epub.oebps.dir">OEBPS/</xsl:variable>
